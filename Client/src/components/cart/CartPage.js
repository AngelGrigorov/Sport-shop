...
import {removeFromCartAction, syncCartAction} from '../../actions/cartActions'
...
class CartPage extends Component {
  ...
  render () {
    ...
    for (let product of productsInCart) {
      product.quantity = this.props.cart.find(i => i.id === product._id).quantity;
    ...
    return (
      <div className='container'>
        <table id='cart' className='table table-hover table-condensed'>
          ...
          <tfoot>
            <tr>
              <td><Link to='/products' className='btn btn-warning'><i className='fa fa-angle-left' /> Continue Shopping</Link></td>
